package com.emineakduman.artbook;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void selectImage(View view){
        //kullanıcının galerisine erişebilmek için izin alıyoruz.
        // bu izin daha önce alınmış mı diye kontrol etmemiz lazım
        if(ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},1);
        }else{
            Intent intentToGallery = new Intent(Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);// galeriye götür demek
    ...
    public void save(View view){
       ...
       // finish();
        ...
        //daha önde açık olan intentleri kapatma
